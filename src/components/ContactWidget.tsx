...
export function XIcon({ className = "h-4 w-4 fill-current" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24">
...
export default function ContactWidget() {
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-2 rounded-full border border-navy/10 bg-surface/90 p-2 shadow-card backdrop-blur-md dark:border-white/10">
